...
class PinView {
    ...
    async initWebpack() {
        ...
        await dev.getHotClient(clientCompiler, this.webpackDevServerOptions.hotClient);
    ...
    middleware() {
        return dev.middleware(this.webpackCompiler, this.webpackDevServerOptions.middleware);
    }
